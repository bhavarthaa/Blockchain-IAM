...
import { Badge, Empty, ErrorCard, Loading, PermissionDenied } from "../../components/ui";
...
export default function AuditPage() {
  ...
  async function exportAudit() {
    try {
      ...
      const response = await fetch(`${API_URL}/api/v1/audit/export?format=csv`, { headers: token ? { Authorization: "Bearer " + token } : {} });
